...
{
    public class SolicitudPanelPago : ISolicitud
    {
        public SolicitudPanelPago(Solicitud solicitud)
        {
            TipoSolicitud = solicitud;
            VisorMensaje = "";
        }

        public SolicitudPanelPago(Solicitud solicitud, string visorMensaje)
        {
            TipoSolicitud = solicitud;
            VisorMensaje = visorMensaje;
        }
